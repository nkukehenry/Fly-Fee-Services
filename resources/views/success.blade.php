...
<head>
    ...
    <title>{{trans('Payment Success')}}</title>
...
<footer class="site-footer" id="footer">
    ...
    <p class="site-footer__fineprint" id="fineprint">{{trans('Copyright')}} ©{{ date('Y') }}  {{trans('All Rights Reserved')}} <a href="{{ url('/') }}" class="site_title">{{ $basic->site_title ?? 'Remittance' }}</a></p>
</footer>
</body>
</html>
