                ...
                <div class="card card-primary shadow">
                    <div class="card-body">
                        ...
                        <div class="form-group ">
                            ...
                            <textarea class="form-control summernote" name="message" id="summernote" rows="20" placeholder="@lang('Say Something')">{{old('message')}}</textarea>
                            @error('message')
                            <span class="text-danger">{{ trans($message) }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="submit-btn-wrapper mt-md-3 text-center text-md-left">
                            <button type="submit" class="btn  btn-rounded btn-primary btn-block"><span>@lang('Send Email')</span> </button>
                        </div>
                    </div>
                </div>
            </div>
